...
# matches with: https://github.com/ros2-gbp/mola-release/archive/release/iron/mola_test_datasets/0.2.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/mola_test_datasets"
SRC_URI = "git://github.com/ros2-gbp/mola-release;${ROS_BRANCH};protocol=https"
SRCREV = "495983eb959ceeb8dfd9e0a45d0ea64cad4b285a"
S = "${WORKDIR}/git"
