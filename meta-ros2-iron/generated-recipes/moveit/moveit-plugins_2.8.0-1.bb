...
# matches with: https://github.com/ros2-gbp/moveit2-release/archive/release/iron/moveit_plugins/2.8.0-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/moveit_plugins"
SRC_URI = "git://github.com/ros2-gbp/moveit2-release;${ROS_BRANCH};protocol=https"
SRCREV = "d52432e0cb40b74f1a65e6c777524a47a5a230b4"
S = "${WORKDIR}/git"
