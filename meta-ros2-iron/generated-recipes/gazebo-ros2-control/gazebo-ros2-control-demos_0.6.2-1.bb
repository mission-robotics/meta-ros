...
# matches with: https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/iron/gazebo_ros2_control_demos/0.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_ros2_control_demos"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "00c0ce6fb2f37a34e1142a8588dcf4ea9de9d5da"
S = "${WORKDIR}/git"
