...
# matches with: https://github.com/ros2-gbp/gazebo_ros2_control-release/archive/release/iron/gazebo_ros2_control/0.6.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/gazebo_ros2_control"
SRC_URI = "git://github.com/ros2-gbp/gazebo_ros2_control-release;${ROS_BRANCH};protocol=https"
SRCREV = "d84aff5c06c372a74ee2a00ba4fe6b8892a73f89"
S = "${WORKDIR}/git"
