...
# matches with: https://github.com/ros2-gbp/ament_lint-release/archive/release/iron/ament_cmake_clang_tidy/0.14.2-1.tar.gz
ROS_BRANCH ?= "branch=release/iron/ament_cmake_clang_tidy"
SRC_URI = "git://github.com/ros2-gbp/ament_lint-release;${ROS_BRANCH};protocol=https"
SRCREV = "3b249571c3e073870dcab1d0bc15e98dac4ede4f"
S = "${WORKDIR}/git"
